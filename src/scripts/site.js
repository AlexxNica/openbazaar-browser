OBB = {};
OBB.controller = {
    api_returns: { // TODO remove this default testing data before live.
...
OBB.controller.generateListingCardInfo = function() {
...
OBB.model = {
    current_store: {
        peer_id: "Qmai9U7856XKgDSvMFExPbQufcsc4ksG779VyG4Md5dn4J",
        // This node's node card info (displayed on Home tab)
        node_card: {
...
// Info needed to generate listing cards
OBB.model.current_store.listing_cards = OBB.controller.generateListingCardInfo();
